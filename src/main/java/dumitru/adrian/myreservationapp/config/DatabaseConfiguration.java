...
@Configuration
@EnableJpaRepositories("dumitru.adrian.myreservationapp.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "dumitru.adrian.myreservationapp.config.HerokuDatabaseConfiguration")
